...
struct sw_animation {
    ...
    union {
        struct { double start; double end; } d;
        struct { struct sw_vec2 start; struct sw_vec2 end; } v;
        struct { struct sw_color start; struct sw_color end; } c;
    } values;
};
...
struct sw_animation* sw_animation_create_color(struct sw_color *target, struct sw_color end, int ms, sw_easing_func e);
